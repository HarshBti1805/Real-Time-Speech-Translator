        ...
        <CardContent className="p-6">
          {translations?.length ? (
              ...
              <AnimatePresence>
                {translations.map((translation, index) => (
                  <motion.div
                    ...
                    tabIndex={0}
                    role="button"
                    aria-expanded={expandedId === translation.id}
                  >
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <motion.span
                          className="text-[13px] font-semibold uppercase tracking-wide bg-gradient-to-r from-pink-500 via-rose-500 to-purple-500 dark:from-pink-400 dark:via-rose-400 dark:to-purple-400 bg-clip-text text-transparent font-mono"
                          whileHover={{
                            scale: 1.05,
                      ...
                      <div className="mb-1 flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-1 ml-auto">
                          <motion.button
                            ...
                            className="cursor-pointer text-gray-400 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400 p-2 rounded-lg transition-all duration-300 opacity-70 hover:opacity-100 hover:bg-cyan-50 dark:hover:bg-cyan-500/10"
                          ...
                          <motion.button
                            ...
                            className="cursor-pointer text-gray-400 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 p-2 rounded-lg transition-all duration-300 opacity-70 hover:opacity-100 hover:bg-red-50 dark:hover:bg-red-500/10"
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.9 }}
                      ...
                      >
                        {expandedId === translation.id ? (
                          ...
                          >
                            <span
                              className="block cursor-text whitespace-pre-line bg-gray-50 dark:bg-black/60 rounded-xl p-4 mt-3 text-sm text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-800 pr-12 select-text backdrop-blur-sm font-mono"
            ...
            >
              ...
              <p className="text-lg font-medium mb-2 font-mono">
