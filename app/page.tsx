  ...
  return (
    <>
      ...
      <main className="overflow-hidden min-h-screen bg-background text-foreground transition-colors duration-300 flex">
        {/* Sidebar - Fixed width on all screen sizes */}
        <AnimatePresence>
          {sidebarOpen && (
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-x-auto">
              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <h1 className="text-xl md:text-2xl font-jetbrains-mono font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                      TranslateHub
                    </h1>
                ...
                <div className="flex items-center justify-end w-full">
                  {/* Desktop User Info */}
                  <div className="hidden md:flex items-center bg-muted/60 border border-border rounded-xl px-4 py-2 shadow-sm gap-4">
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center space-x-2">
                                <h3
                                  className={`font-semibold text-lg font-jetbrains-mono ${
                                    isActive
                                      ? "text-foreground"
                                      : "text-foreground/90"
                                  }`}
          ...
          {/* Main Content */}
          <main className="px-4 py-4 lg:py-8 min-w-0">
          ...
          {/* Footer */}
          <footer className="border-t border-border bg-muted/50 mt-8 lg:mt-16">
            <div className="px-4 py-6 lg:py-8 min-w-0">
              <div className="text-center">
